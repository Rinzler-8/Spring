...
const getEmailExists = (email) => {
  let url = "accounts/EmailExists/" + email;
  return api("GET", url, null);
};

// Check exist by Username
const getUsernameExists = (username) => {
  let url = "accounts/UsernameExists/" + username;
  return api("GET", url, null);
};
// Check exist by Mobile
const getMobileExists = (mobile) => {
  let url = "accounts/MobileExists/" + mobile;
  return api("GET", url, null);
};
...
// export
export { getAccountAPIList, getEmailExists, getUsernameExists, addAccountNewAPI, deleteAccountAPI, updateAccountAPI, getMobileExists };
