...
import { actionFetchAccountUpdateInfoRedux, actionToggleFormRedux } from "./../Redux/Action/FormUpdateAction";
...
function AdminContainer(props) {
  ...
  let onHandleUpdateAccount = (AccountUpdate_New) => {
    ...
    dispatchRedux(actionUpdateAccountAPI(id, AccountUpdate_New));
  };
