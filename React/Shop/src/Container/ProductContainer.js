...
import { actionAddProductAPI, actionDeleteProductAPI, actionFetchProductAPI, actionUpdateProductAPI } from "../Redux/Action/ProductAction";
...
import { actionToggleProductFormRedux } from "./../Redux/Action/FormUpdateAction";
...
function ProductContainer(props) {
  ...
  let onHandleEdit = (productUpdate) => {
    ...
    // Hiển thị formUpdate
    dispatchRedux(actionToggleProductFormRedux());
  };
  ...
  return (
    <Container>
      ...
      <Grid container spacing={3} py={3} className="grid-container">
        {<Product />}
      </Grid>
